...
public class SaveLoad
{
    ...
    {
        string path = Path.Combine(Application.persistentDataPath, "gameData.acd"); // save data file location
    ...
    public static GameData LoadData()
    {
        ...
        {
            Debug.Log("Game data file not found at " + path); 
            SaveData(); // create a new save file
            Debug.Log("New game data file created at " + path);
            return null;
        }
    }
}